...
namespace FindBalloons
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private bool IsSmallerThenMaxDiameter(Balloon balloon)
        {
        ...
        {
            var filter = new Predicate<Balloon>(IsSmallerThenMaxDiameter);
            List<Balloon> foundBalloons = _partyList.FindAll(filter);
